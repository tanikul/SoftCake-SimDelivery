	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
	   		<ul class="progress-tracker"> 
	   			...
	   			<li class="step-2-title progress-tracker-visited"> 
	   			...
	   			<li class="step-3-title progress-tracker-active"> 
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-success">
			      <div class="panel-heading">
			        <h3 class="panel-title">รายละเอียดการจอง Booking No. ${bookingId}</h3>
			      </div>
			      <div class="panel-body">
					...
					<div class="row">
						...
						<button type="button" class="btn btn-danger" id="cancel-btn">กลับไปหน้าแรก</button>
						</div>
					</div>
      			  </div>
    			</div>

...
<t:master>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
	            <div class="x_panel">
	              <div class="x_title">
	                <h2><i class="fa fa-bar-chart"></i> Daily Report</h2>
	              ...
	              <div class="x_content">
					<form class="form-horizontal">
						...
						<div class="form-group">
						    <label for="inputEmail3" class="col-sm-2 control-label">เลือกบริการ</label>
						    <div class="col-sm-2">
						    ...
						    <label for="inputEmail3" class="col-sm-2 control-label">เลือก media</label>
						    <div class="col-sm-2">
						    	<select class="form-control selectpicker">
